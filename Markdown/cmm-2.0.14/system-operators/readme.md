...
- [2 Installation](./2-installation.md#2-installation)
  ...
  - [2.4 Metrics Agent on the OpenStack Platform](./2-installation.md#24-metrics-agent-on-the-openstack-platform)
    - [2.4.1 Metric Agent Prerequisites](./2-installation.md#241-metric-agent-prerequisites)
    - [2.4.2 Metric Agent Installation](./2-installation.md#242-metric-agent-installation)
    - [2.4.3 Metric Agent Updating the Configuration File](./2-installation.md#243-metric-agent-updating-the-configuration-file)
    - [2.4.4 Activating Additional Metrics](./2-installation.md#244-activating-additional-metrics)
